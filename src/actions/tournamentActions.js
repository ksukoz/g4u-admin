...
export const addTournament = (tournamentData) => (dispatch) => {
	axios
		.post('http://api.mygame4u.com/admin/tournaments/add', tournamentData, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
		.then((res) => {
			if (res.data.error) {
...
export const addSubTournament = (subTournamentData) => (dispatch) => {
	axios
		.post('http://api.mygame4u.com/admin/tournaments/addsubtour', subTournamentData, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
...
export const addCommands = (commandData) => (dispatch) => {
	axios
		.post('http://api.mygame4u.com/admin/tournaments/addcommands', commandData, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
...
export const editDatelessGames = (gameData) => (dispatch) => {
	axios
		.post('http://api.mygame4u.com/admin/tournaments/addtimetogames', gameData, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
...
export const deleteCommands = (commandData) => (dispatch) => {
	axios
		.post('http://api.mygame4u.com/admin/tournaments/delcommands', commandData, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
...
export const getDatelessGames = (id) => (dispatch) => {
	axios
		.get(`http://api.mygame4u.com/admin/tournaments/getofftimegames?subId=${id}`, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
...
export const getGamePlayers = (id) => (dispatch) => {
	axios
		.get(`http://api.mygame4u.com/admin/tournaments/consist/${id}`, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
...
export const addGamePlayers = (id, players) => (dispatch) => {
	axios
		.post(`http://api.mygame4u.com/admin/tournaments/updateconsist/${id}`, players, {
			headers: {
				Authorization: `G4User ${JSON.parse(localStorage.getItem('admin-user')).token}`
			}
		})
