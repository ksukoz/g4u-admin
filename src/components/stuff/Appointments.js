...
import { getGamesByName, addAppoint, getAppoints, deleteAppoint, clearGames } from '../../actions/tournamentActions';
	...
	render() {
		...
		if (appoints) {
			appointsList = appoints.map(
				(appoint) => (
					// appoint.personal && appoint.game
					// 	? console.log(appoint.personal.photo)
					// :
					<ExpansionPanel key={appoint.personal.id}>
						<ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
							<div className={classes.flexSummary}>
								...
								/>
								<h3>
									{`${appoint.personal.name} ${appoint.personal.patronymic} ${appoint.personal
										.surename} (${appoint.personal.type})`}
								</h3>
							</div>
						...
						<ExpansionPanelDetails>
							<Table>
								...
								<TableBody>
									{appoint.games.map((game) => (
										<TableRow>
											<TableCell component="th" scope="row">
												<img src={game.game.in.logo} style={{ width: '50px' }} alt="" />
											</TableCell>
											<TableCell component="th" scope="row">
												{game.game.in.title}
											</TableCell>
											...
											<TableCell component="th" scope="row">
												<img src={game.game.out.logo} style={{ width: '50px' }} alt="" />
											</TableCell>
											<TableCell component="th" scope="row">
												<Button
													className={classes.button}
													onClick={this.onDelHandler.bind(this, game.asmgId)}
												>
													&#10006;
												</Button>
											</TableCell>
		...
		return (
			<div className={classes.wrap}>
				<div className={classes.form}>
										...
										{this.state.stuffList.map((stuff) => (
											<MenuItem
												...
												onClick={this.onClickHandler.bind(
													this,
													'stuff',
													`${stuff.surename} ${stuff.name} ${stuff.patronymic} - ${stuff.type}`,
													stuff.id
												)}
											>
												<span>
												...
												<span
												>{`${stuff.surename} ${stuff.name} ${stuff.patronymic} - ${stuff.type}`}</span>
											</MenuItem>
										))}
									</List>
								) : (
					...
					{/* <TableBody> */}
					<Paper style={{ width: '100%' }}>{appointsList}</Paper>
					{/* </TableBody> */}
					{/* </Table> */}
				</div>
