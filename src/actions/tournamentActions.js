...
export const changeTournamentStatus = id => dispatch => {
  axios
    .get(`http://api.mygame4u.com/admin/tournaments/setstatus?id=${id}`, {
      headers: {
        Authorization: `G4User ${
          JSON.parse(localStorage.getItem("admin-user")).token
        }`
...
export const addGamePlayers = (id, players) => dispatch => {
  axios
    .post(
      `http://api.mygame4u.com/admin/tournaments/updateconsist/${id}`,
      players,
      {
        headers: {
          Authorization: `G4User ${
